...
ActiveRecord::Schema[7.1].define(version: 2024_03_11_131536) do
  ...
  create_table "edited_orders", force: :cascade do |t|
    t.bigint "menu_id", null: false
    t.bigint "order_group_id", null: false
    t.integer "quantity"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["menu_id"], name: "index_edited_orders_on_menu_id"
    t.index ["order_group_id"], name: "index_edited_orders_on_order_group_id"
  end
  ...
  create_table "menus", force: :cascade do |t|
    ...
    t.boolean "pin_to_top", default: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "created_by"
  ...
  create_table "order_groups", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "casher_name"
    t.string "waiter_name"
    t.bigint "user_id"
    t.string "created_by"
    t.integer "order_number"
    t.index ["created_at"], name: "index_order_groups_on_created_at"
    t.index ["created_by"], name: "index_order_groups_on_created_by"
  ...
  add_foreign_key "edited_orders", "menus"
  add_foreign_key "edited_orders", "order_groups"
